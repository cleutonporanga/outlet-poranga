...
const MOCK_PRODUCTS: Product[] = [
  { id: '1', name: 'Camiseta Basic Oversized', category: 'Camisetas', size: 'G', color: 'Preto', quantity: 12, price: 89.90, createdAt: new Date().toISOString() },
  { id: '2', name: 'Calça Jeans Slim', category: 'Calças', size: '42', color: 'Azul', quantity: 3, price: 159.00, createdAt: new Date().toISOString() },
  { id: '3', name: 'Vestido Midi Floral', category: 'Vestidos', size: 'M', color: 'Verde', quantity: 8, price: 199.90, createdAt: new Date().toISOString() },
  { id: '4', name: 'Jaqueta Puffer', category: 'Casacos', size: 'P', color: 'Bege', quantity: 2, price: 299.00, createdAt: new Date().toISOString() },
];

const MOCK_MOVEMENTS: Movement[] = [
  { id: 'm1', productId: '1', productName: 'Camiseta Basic Oversized', type: 'entrada', quantity: 20, date: new Date().toISOString() },
  { id: 'm2', productId: '1', productName: 'Camiseta Basic Oversized', type: 'saída', quantity: 8, date: new Date().toISOString() },
  { id: 'm3', productId: '2', productName: 'Calça Jeans Slim', type: 'entrada', quantity: 5, date: new Date().toISOString() },
  { id: 'm4', productId: '2', productName: 'Calça Jeans Slim', type: 'saída', quantity: 2, date: new Date().toISOString() },
];
...
export default function InventoryApp() {
  ...
  const handleAddProduct = (newProduct: Omit<Product, 'id' | 'createdAt'>) => {
    ...
    // Auto-create movement for initial stock
  ...
  return (
    <div className="flex flex-col h-screen max-w-md mx-auto bg-background overflow-hidden relative shadow-2xl">
      <header className="bg-white px-6 pt-8 pb-4 border-b">
        ...
        <p className="text-sm text-muted-foreground">Gerenciamento de Inventário</p>
      </header>
      ...
      <Tabs defaultValue="inicio" className="flex-1 flex flex-col">
        <TabsList className="w-full justify-start overflow-x-auto bg-white border-b rounded-none p-0 h-auto hide-scrollbar sticky top-0 z-40">
          ...
          <TabsTrigger value="movimentacoes" className="top-tab-trigger min-w-[130px]">Movimentações</TabsTrigger>
        ...
        <div className="flex-1 overflow-y-auto pb-24">
          ...
          <TabsContent value="movimentacoes" className="m-0 focus-visible:ring-0">
